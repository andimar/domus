...
if ( $regina_lite_news_section_show == 1 ) {
	echo '<section class="bg-block-white" id="section-news" style="padding-top:10px">';
	echo '<a id="offerte"></a>';
	echo '<div class="container">';

	if(function_exists('avviso')){
		avviso('Il laboratorio rimarrà chiuso per ferie dal 9 al 27 agosto 2023. <br>Attenzione anche all\'<a href="#orari" style="color:darkblue;text-decoration:underline"><strong>orario estivo</strong></a> per i referti', '2023-08-28'); 
	}
